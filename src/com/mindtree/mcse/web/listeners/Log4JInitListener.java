package com.mindtree.mcse.web.listeners;
...
public class Log4JInitListener implements ServletContextListener {
	...
	public static final String JNDI_LOG4J_URL = "java:/comp/env/url/log4j.configuration";
	...
	public void contextInitialized(ServletContextEvent arg0) {
		String path = null;
		try {
			//getting JNDI value from the WEB-INF/web.xml
